...
int main(int argc, char **argv)
{
    ...
    Object<ztype::FontCache> cache = ztype::FontCache::Create();
    ...
    if (lists)
    {
        ...
        iterate2 (i, inputs)
        {
            Object<FaceListFile> face_list = FaceListFile::Open((String&) i);
            ...
            if ((n = cache->BuildUpdateList(face_list, cache_dir, force, verbose)) < 0)
            {
