...
namespace ztype
{
    ...
    class FaceListFile
    {
        public:
            ...
            static FaceListFile* Open(std::unique_ptr<li::InputStream>&& stream);
    ...
    {
        public:
            static FaceFile* Create(const char *file_name);
    ...
    class Rasterizer
    {
        public:
            ...
            static Rasterizer* Create(li::InputStream* ttfFile, int pxsize);
            virtual ~Rasterizer() {}
